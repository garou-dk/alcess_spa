...
import { AddProductFormErrorInterface, AddProductFormInterface, ProductInterface } from '@/interfaces/ProductInterface';
...
const handleSubmit = async () => {
    const data = validate();
    if (data) {
        await submitService.patch(`admin/products/${props.data.product_id}`, data).then(() => {
            if (
