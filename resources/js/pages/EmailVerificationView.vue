    ...
    <div class="flex h-svh items-center justify-center">
        <div>
            <div class="mb-2 flex justify-center">
                <img :src="ImgLogo" class="h-32 w-32" alt="Store Icon" />
            </div>
            <div v-if="submitService.request.loading">
                <div class="mb-2">
                    <h1 class="dots-loader text-2xl font-semibold">
                        Verifying email<span class="dots"
            ...
            <div v-else-if="submitService.request.status === 200">
                <h1 class="p-2 text-center text-2xl font-semibold">
            ...
            <div v-else>
                ...
                <p class="text-center">
                    Please try logging in to your account, and we will send you
                    another email verification link.
                </p>
            </div>
            <div
                v-if="!submitService.request.loading"
